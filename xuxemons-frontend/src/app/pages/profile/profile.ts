...
import { BattleTeam } from '../../core/components/battle-team/battle-team';

@Component({
  selector: 'app-profile',
  standalone: true,
  imports: [CommonModule, RouterLink, Breadcrumb, TrainerLvl, Collection, TotalBattles, BattleTeam],
