...
@Component({
  selector: 'app-xuxemon-detail-modal',
  imports: [],
  templateUrl: './xuxemon-detail-modal.html',
  styleUrl: './xuxemon-detail-modal.css',
})
export class XuxemonDetailModal implements AfterViewInit {
  @Input({ required: true }) cardContext!: any;
