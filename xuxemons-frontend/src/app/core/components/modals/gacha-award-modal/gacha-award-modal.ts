...
@Component({
  selector: 'app-gacha-award-modal',
  imports: [],
  templateUrl: './gacha-award-modal.html',
  styleUrl: './gacha-award-modal.css',
})
export class GachaAwardModal implements AfterViewInit {
  @Input({ required: true }) gachaContext!: any;
